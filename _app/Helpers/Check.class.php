...
class Check {
     ...
     */
    public static function Image($ImageUrl, $ImageDesc, $ImageW = null, $ImageH = null, $Class = null, $Zc = NULL) {
        ...
        if (file_exists(self::$Data) && !is_dir(self::$Data)):
            ...
            $imagem = self::$Data;
            //var_dump($ImageUrl);
            return "<img src=\"{$patch}/tim.php?src={$patch}/{$imagem}&w={$ImageW}&h={$ImageH}&zc={$Zc}\"  alt=\"{$ImageDesc}\" title=\"{$ImageDesc}\" class=\"{$Class}\"  />";
        else:
            return false;
        endif;
    }

        public static function ImageDash($ImageUrl, $ImageDesc, $ImageW = null, $ImageH = null, $Class = null, $Zc = NULL) {
...
//var_dump($ImageUrl);
    ...
    public static function ImgRes($ImageUrl, $ImageDesc, $Zc = NULL, $Q ,$Class = null) {
        ...
        if (file_exists(self::$Data) && !is_dir(self::$Data)):
            ...
            return "<img src=tim.php?src={$patch}/{$imagem}&zc={$Zc}&q={$Q}\"  alt=\"{$ImageDesc}\" title=\"{$ImageDesc}\" class=\"{$Class}\"  />";
        else:
            return false;
        endif;
    }
    ...
    public static function Real($Dinheiro) {
        if(!empty($Dinheiro)){
            self::$Data = number_format($Dinheiro, 2, ',', '.');
