...
class Email {
    ...
    private function sendMail() {
        if ($this->Mail->Send()):
            $this->Error = ['Obrigado por entrar em contato: Recebemos sua mensagem e responderemos em breve!', KFR_SUCESSO];
            $this->Result = true;
        else:
            $this->Error = ["Erro ao enviar: Entre em contato com o admin. ( {$this->Mail->ErrorInfo} )", KFR_ERRO];
            $this->Result = false;
        endif;
    }
